...
import Standart from '../pics/standart2.jpeg';

export const ThreePlacedStandart1=()=>{
    const navigate=useNavigate();
    function toOverview(){
        navigate('/other_pages/rooms/standart_category/rooms_overviews/ThreePlacedOverview1');
    }
    return(
        <div>
