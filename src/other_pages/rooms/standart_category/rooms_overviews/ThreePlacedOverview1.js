...
export const ThreePlacedOverviewStand1=()=>{
    const pics=useSliderPics(state=>state.pics10);
            ...
            <main>
                <section>
                    ...
                    Трёхместный стандарт
                        ...
                        <b>15 кв.м</b>
                        <a href='/other_pages/Booking?room-type=170644' className='book'>Забронировать</a>
                    </div>
                </section>
