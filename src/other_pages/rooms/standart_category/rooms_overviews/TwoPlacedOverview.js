...
export const TwoPlacedOverviewStand=()=>{
    const pics=useSliderPics(state=>state.pics9);
        ...
        <div className="room">
            ...
            <main>
                ...
                <span className='description'>
                    Двухместный номер. Присутствует кондиционер, телевизор, камод, журнальный столик, тумбочка, вешалка. <br></br>
                    Санузел в номере: душ, раковина, унитаз.
                </span>
                <h1>Цены</h1>
                <ul>
                    <li><b>01.06-20.06:</b> 1200 рублей</li>
