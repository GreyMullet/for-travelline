...
export const ThreePlacedOverviewStand2=()=>{
    const pics=useSliderPics(state=>state.pics11);
            ...
            <main>
                <section>
                    ...
                    Трёхместный стандарт
                        ...
                        <b>15 кв.м</b>
                        <a href='/other_pages/Booking?room-type=170645' className='book'>Забронировать</a>
                    </div>
                </section>
