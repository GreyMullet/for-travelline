...
export const TwoPlacedOverview3=()=>{
    const pics=useSliderPics(state=>state.pics7);
            ...
            <main>
                <section>
                    ...
                    Двухместный комфорт
                        ...
                        <b>15 кв.м</b>
                        <a href='/other_pages/Booking?room-type=237754' className='book'>Забронировать</a>
                    </div>
                </section>
                <span className='description'>
                    Двухместный номер. Присутствует кондиционер, телевизор, журнальный столик, шкаф, <br></br>
                    две прикроватные тумбочки, холодильник. Санузел в номере: душ, раковина, унитаз. Номер тёмный, <br></br>
                    так как вид с окна выходит на стену.
                </span>
                <h1>Цены</h1>
                <ul>
                    <li><b>01.05-20.06:</b> 1200 рублей</li>
                    <li><b>21.06-15.07:</b> 1500 рублей</li>
                    <li><b>16.07-28.08:</b> 2000 рублей</li>
                    <li><b>29.08-30.09:</b> 1200 рублей</li>
                </ul>
            </main>
            <Footer />
        </div>
