...
export const TwoPlacedOverview2=()=>{
    const pics=useSliderPics(state=>state.pics6);
            ...
            <main>
                <section>
                    ...
                    <div className='reserve'>
                        ...
                        <b>15 кв.м</b>
                        <a href='/other_pages/Booking?room-type=170641' className='book'>Забронировать</a>
                    </div>
                </section>
                <span className='description'>
                    Двухместный номер. Присутствует кондиционер, телевизор, журнальный столик, шкаф, холодильник, <br></br>
                    прикроватная тумбочка. Санузел в номере: душ, раковина, унитаз.
                </span>
                <h1>Цены</h1>
                <ul>
