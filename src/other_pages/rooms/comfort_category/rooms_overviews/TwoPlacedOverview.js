...
export const TwoPlacedOverview=()=>{
    const pics=useSliderPics(state=>state.pics4);
            ...
            <main>
                <section>
                    ...
                    Двухместный комфорт.
                        ...
                        <b>15 кв.м</b>
                        <a href='/other_pages/Booking?room-type=281602' className='book'>Забронировать</a>
                    </div>
                </section>
                <span className='description'>
                    Двуспальная кровать, две прикроватные тумбочки, шкаф для вещей, холодильник, <br></br>
                    журнальный столик, кондиционер, телевизор. В санузле душевая кабина, унитаз, раковина. <br></br>
