...
export const ThreePlacedOverview1=()=>{
    const pics=useSliderPics(state=>state.pics3);
        ...
        <div className="room">
            ...
            <main>
                ...
                <span className='description'>
                    Двуспальная, односпальная кровати, две прикроватные тумбочки, шкаф для вещей, холодильник, <br></br>
